...
<div class="wrap">
    ...
    <p class="description">
        ...
        If you lock yourself out, add <code>define('PRESS_SENTINEL_SAFE_MODE', true);</code> to <code>wp-config.php</code> (before plugins load) or set <code>recovery.safe_mode</code> to <code>true</code> in <code>config/plugin.php</code>, reload once, sign in at <code>wp-login.php</code>, then turn safe mode off.
