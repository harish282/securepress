...
/**
 * Settings → SecurePress Headers admin page.
 *
...
{
    public const PAGE_SLUG = 'securepress-security-headers';
    ...
    public const SECTION_XFO = 'securepress_section_xfo';

    public const SECTION_REFERRER = 'securepress_section_referrer';

    public const SECTION_PERMISSIONS = 'securepress_section_permissions';

    public const SECTION_XCTO = 'securepress_section_xcto';
