 ...
 *  - Mirrors the {@see \NiyiGuard\Core\Auth\AuthHardeningOptions} contract
...
{
    public const OPTION_NAME = 'niyiguard_rate_limit';
     ...
     * and window. Used by the NiyiGuard dashboard's feature-toggle form so
