 ...
 *     ]
 *
 * The master `enabled` flag was added so the centralized NiyiGuard dashboard can
...
{
    public const OPTION_NAME = 'niyiguard_security_headers';
     ...
     * sub-setting. Used by the centralized NiyiGuard dashboard.
     */
